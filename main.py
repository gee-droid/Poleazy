...
def run_demo_pipeline() -> tuple[object, dict]:
...
if __name__ == "__main__":
    ...
    print(f"Target Site: {payload.geospatial.target_address}")
    print(f"Affected Parcels: {payload.geospatial.affected_parcels_count}")